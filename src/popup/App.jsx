    ...
    return (
        <div className="w-full h-full flex flex-col bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4">
                ...
                {/* Tabs */}
                <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 rounded-lg p-0.5">
      ...
      `}
                        >
                            <div className="flex items-center justify-center space-x-1">
                                ...
                                <span>{tab}</span>
                                <span className="text-[10px] bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 px-1 py-0.5 rounded-full">
            ...
            {/* Controls */}
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-2 space-y-0">
                {/* Search & Actions Row */}
                <div className="flex items-center gap-2 w-full">
                    <div className="relative flex-1 min-w-0">
                        ...
                        <input
                            ...
                            className="w-full pl-7 pr-2 py-1 border border-gray-300 dark:border-gray-600 rounded focus:ring-1 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-gray-900 text-xs text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                        />
                    </div>

                    <button
                        onClick={() => setShowNewItemForm(true)}
                        className="px-2 py-1 bg-primary-600 text-white rounded hover:bg-primary-700 transition-colors text-xs font-medium"
                    >
                        Add
                    </button>
                    ...
                    <button
                        ...
                        className="px-2 py-1 bg-green-600 text-white rounded hover:bg-green-700 transition-colors text-xs font-medium flex items-center space-x-1"
                    >
                        <Download className="w-3 h-3" />
                    </button>

                    <label className="px-2 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-xs font-medium cursor-pointer flex items-center space-x-1">
                    ...
                    <button
                        onClick={handleClear}
                        className="px-2 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition-colors text-xs font-medium flex items-center space-x-1"
                    >
                        <Trash2 className="w-3 h-3" />
                    </button>

                    <div className="ml-auto text-xs text-gray-600 dark:text-gray-300 flex items-center space-x-2">
            ...
            {/* New Item Form */}
            {showNewItemForm && (
                <div className="bg-blue-50 dark:bg-gray-900 border-b border-blue-200 dark:border-blue-700 p-2">
                    <div className="flex items-center justify-between mb-1">
                        <h3 className="font-medium text-xs text-blue-900 dark:text-blue-200">Add New Item</h3>
                        <button
                            onClick={() => setShowNewItemForm(false)}
                            className="text-blue-600 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-400 p-0.5"
                        >
                            <X className="w-3 h-3" />
                        </button>
                    </div>
                    <div className="grid grid-cols-2 gap-1 mb-1">
                        <input
                            ...
                            className="px-2 py-1 border border-blue-300 dark:border-blue-700 rounded focus:ring-1 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-900 text-xs text-gray-900 dark:text-gray-100"
                        />
                        <input
                            type="text"
                            placeholder="Value"
